...
import (
	...
	"getcare-notification/internal/route/api"
	"net/http"
...
func (r *route) RunAPI() error {
	...
	requestOtpRoutes := apiRoutes.Group("/request_otp", middleware.Base(), middleware.Cors(), middleware.Authorize())
	{
	...
	userFcmRoutes := apiRoutes.Group("/user_fcm", middleware.Base(), middleware.Cors(), middleware.Authorize())
	{
	...
	verifyOtpRoutes := apiRoutes.Group("/verify_otp", middleware.Base(), middleware.Cors(), middleware.Authorize())
	{
