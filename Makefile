export PROJ_PATH=getcare-messenger
...
regen: ## regenerate generated code
	gen \
     --sqltype=mysql \
     --connstr='root:C4RJVX8GZEZQ6DM6@tcp(getcare-dev.cnzuid89fraf.ap-southeast-1.rds.amazonaws.com:3306)/getcare?charset=utf8&parseTime=True&loc=Local' \
     --database=getcare-dev \
